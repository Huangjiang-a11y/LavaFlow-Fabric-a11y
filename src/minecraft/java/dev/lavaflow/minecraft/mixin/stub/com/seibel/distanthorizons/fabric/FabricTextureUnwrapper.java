...
/**
 * Signature-only stub of Distant Horizons' Fabric texture unwrapper.
 *
 ...
 */
public class FabricTextureUnwrapper {
    public static int getGlTextureIdFromGpuTexture(Object gpuTexture) {
        return -1;
    }
}
